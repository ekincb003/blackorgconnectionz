import { generateMonogramDataUrl, generateChapterBannerSvg } from './avatarGenerator';
...
export const INITIAL_ORGS: Organization[] = [
  ...
  // 1. Alpha Kappa Alpha
  {
    ...
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1908', bgColor: '#008053', textColor: '#F7C6D0' }),
    banner: generateChapterBannerSvg('Alpha Kappa Alpha', 'Founded Jan. 15, 1908 • Kappa Theta Chapter', '#008053', '#F7C6D0'),
    primaryColor: '#F7C6D0',
  ...
  // 2. Kappa Alpha Psi (1911)
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1911', bgColor: '#9B111E', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Kappa Alpha Psi', 'Founded Jan. 5, 1911 • Eta Zeta Chapter', '#9B111E', '#F5F5DC'),
    primaryColor: '#9B111E',
  ...
  // 3. Omega Psi Phi (1911)
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1911', bgColor: '#4B0082', textColor: '#DAA520' }),
    banner: generateChapterBannerSvg('Omega Psi Phi', 'Founded Nov. 17, 1911 • Sigma Eta Chapter', '#4B0082', '#DAA520'),
    primaryColor: '#4B0082',
  ...
  // 4. Delta Sigma Theta (1913)
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1913', bgColor: '#9B111E', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Delta Sigma Theta', 'Founded Jan. 13, 1913 • Mu Chi Chapter', '#9B111E', '#FFFFFF'),
    primaryColor: '#9B111E',
  ...
  // 5. Phi Beta Sigma (FULL PROFILE - Claimed by Elijah Kincade)
  {
    ...
    logo: generateMonogramDataUrl({ text: '1914', bgColor: '#002B7F', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Phi Beta Sigma', 'GOMAB 1914 • Gamma Rho Nu Chapter', '#002B7F', '#FFFFFF'),
    primaryColor: '#002B7F',
    secondaryColor: '#FFFFFF',
  ...
  // 6. Zeta Phi Beta (1920)
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1920', bgColor: '#002B7F', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Zeta Phi Beta', 'Since 1920 • Epsilon Sigma Chapter', '#002B7F', '#FFFFFF'),
    primaryColor: '#002B7F',
    secondaryColor: '#FFFFFF',
  ...
  // 7. Sigma Gamma Rho (1922)
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: '1922', bgColor: '#002B7F', textColor: '#FFD700' }),
    banner: generateChapterBannerSvg('Sigma Gamma Rho', 'Founded Nov. 12, 1922 • Xi Rho Chapter', '#002B7F', '#FFD700'),
    primaryColor: '#002B7F',
  ...
  // 8. National Pan-Hellenic Council
  {
    ...
    category: 'Fraternities & Sororities (NPHC)',
    isClaimed: false,
    logo: generateMonogramDataUrl({ text: 'NPHC', bgColor: '#111827', textColor: '#D4AF37' }),
    banner: generateChapterBannerSvg('National Pan-Hellenic Council', 'Divine Nine Collegiate Council • 1930', '#111827', '#D4AF37'),
    primaryColor: '#800020',
  ...
  // 9. AAUS
  {
    ...
    logo: generateMonogramDataUrl({ text: 'AAUS', bgColor: '#005A9C', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('African Americans United in Science', 'Excellence in STEM & Healthcare', '#005A9C', '#00A86B'),
    primaryColor: '#005A9C',
  ...
  // 10. BGSA
  {
    ...
    isClaimed: false,
    claimedByUserId: undefined,
    logo: generateMonogramDataUrl({ text: 'BGSA', bgColor: '#4A154B', textColor: '#D4AF37' }),
    banner: generateChapterBannerSvg('Black Graduate Student Association', 'Excellence in Advanced Scholarship', '#4A154B', '#D4AF37'),
    primaryColor: '#4A154B',
    secondaryColor: '#D4AF37',
  ...
  // 11. B'Psych
  {
    ...
    isClaimed: false,
    claimedByUserId: undefined,
    logo: generateMonogramDataUrl({ text: 'BPSY', bgColor: '#1B4D3E', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Black Psych Society', 'Psychology & Mental Health Advocacy', '#1B4D3E', '#FFFFFF'),
    primaryColor: '#2B6CB0',
  ...
  // 14. NSBE
  {
    ...
    isClaimed: false,
    claimedByUserId: undefined,
    logo: generateMonogramDataUrl({ text: 'NSBE', bgColor: '#7B1113', textColor: '#D4AF37' }),
    banner: generateChapterBannerSvg('National Society of Black Engineers', 'Engineering, Innovation & Tech Leadership', '#7B1113', '#D4AF37'),
    primaryColor: '#005A9C',
    secondaryColor: '#FFD700',
  ...
  // 15. BSU (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'BSU', bgColor: '#B8860B', textColor: '#000000' }),
    banner: generateChapterBannerSvg('Black Student Union', 'The Central Voice of Campus Black Scholars', '#B8860B', '#000000'),
    primaryColor: '#800020',
    secondaryColor: '#D4AF37',
  ...
  // 16. BLAACK (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'BLAK', bgColor: '#800020', textColor: '#FFD700' }),
    banner: generateChapterBannerSvg('BLAACK', 'Building Leaders and Activists in Cultural Knowledge', '#800020', '#FFD700'),
    primaryColor: '#000000',
    secondaryColor: '#D4AF37',
  ...
  // 17. CSU (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'CSU', bgColor: '#006400', textColor: '#FFD700' }),
    banner: generateChapterBannerSvg('Caribbean Student Union', 'Celebrating Caribbean Heritage, Culture & Unity', '#006400', '#FFD700'),
    primaryColor: '#008080',
    secondaryColor: '#FFD700',
  ...
  // 18. EASA (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'EASA', bgColor: '#8B0000', textColor: '#FFD700' }),
    banner: generateChapterBannerSvg('East African Student Association', 'Honoring East African Traditions & Community', '#8B0000', '#FFD700'),
    primaryColor: '#006400',
    secondaryColor: '#D4AF37',
  ...
  // 19. NSA (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'NSA', bgColor: '#008751', textColor: '#FFFFFF' }),
    banner: generateChapterBannerSvg('Nigerian Student Association', 'Excellence, Culture & Nigerian Collegiate Pride', '#008751', '#FFFFFF'),
    primaryColor: '#008751',
    secondaryColor: '#FFFFFF',
  ...
  // 20. S.A.S.I. (Admin: Elijah Kincade)
  {
    ...
    isClaimed: false,
    claimedByUserId: 'user-elijah',
    logo: generateMonogramDataUrl({ text: 'SASI', bgColor: '#0047AB', textColor: '#FFDF00' }),
    banner: generateChapterBannerSvg('Students of African Stories & Intersectionality', 'Storytelling, Film & Creative Media', '#0047AB', '#FFDF00'),
    primaryColor: '#9B111E',
